...
const manifestoParagraphs = [
  "Мы не гонимся за шумом — мы находим точки входа.",
  "Создаем события, которые меняют контекст: для брендов, сцен и целых городов.",
  "Разрабатываем форматы, где нужные люди встречаются в идеальном месте и моменте.",
  "Работаем с артистами и сообществами, для которых честность важнее цифр, а настоящая культура — выше трендов.",
  "KEY — это ключ к сети продюсеров, режиссеров, промоутеров, сценографов, звукоинженеров и креаторов, чья жизнь — в ночи, ритме и уличной энергии.",
  "Мы связываем бренды, таланты и локации так, чтобы каждый контакт превращался в опыт, а не в механику.",
  "Наши проекты — не разовые тусовки, а целая система впечатлений, которая живет в соцсетях, комьюнити и воспоминаниях.",
];
