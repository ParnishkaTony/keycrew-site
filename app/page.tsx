...
const manifestoParagraphs = [
  ...
  "KEY - это ключ к сети продюсеров, режиссеров, промоутеров, сценографов, звукоинженеров и креаторов.",
  "Мы связываем бренды, таланты и локации так, чтобы каждый контакт превращался в опыт.",
